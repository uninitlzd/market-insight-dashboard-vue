      ...
      <div class="border-r pr-4 mr-4 flex flex-col" style="width: 150px">
        <div class="h-full mb-0">
          <ul class="period-filter-options">
            ...
            >
              <span class="cursor-pointer">Yesterday</span>
            </li>
            <li
              @click="applyLastWeekRange"
              class="text-sm border-b py-2"
            >
              <span class="cursor-pointer">Last 7 Days</span>
            </li>
            <li
              @click="applyLast30DaysRange"
              class="text-sm border-b py-2"
            >
              <span class="cursor-pointer">Last 30 Days</span>
            </li>
            <li
              @click="applyCurrentMonthRange"
              class="text-sm border-b py-2"
            >
              <span class="cursor-pointer">This Month</span>
            </li>
            <li @click="applyCustomRange" class="text-sm py-2">
              <span class="cursor-pointer">Custom</span>
            </li>
          </ul>
        </div>
        <button
